...
@Component({
  ...
  styleUrls: ['./outdoor-list.component.scss']
})


export class OutdoorListComponent extends BasePageComponent implements AfterViewInit, OnDestroy, OnInit {
  persons: any[];
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.http
          .post<DataTablesResponse>(
            environment.serverURL+'/outdoor/datatable',
