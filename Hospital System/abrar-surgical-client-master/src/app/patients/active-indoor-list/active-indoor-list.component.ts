...
@Component({
  selector: 'active-indoor-list',
  templateUrl: './active-indoor-list.component.html',
  styleUrls: ['./active-indoor-list.component.scss']
})


export class ActiveIndoorListComponent extends BasePageComponent implements AfterViewInit, OnDestroy, OnInit {
  ...
  ngOnInit() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        console.log(this.search_indoor_id);
        this.http
          .post<DataTablesResponse>(
            environment.serverURL+'/indoor/active-datatable',
